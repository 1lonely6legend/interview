...
class BBox {
  public:
    ...
    void addPoint(float x, float y) {
      point_array.emplace_back(Point{x, y});
    }
    bool isCollision(BBox other) {
      int min_x1 = std::min_element(point_array.begin(),
                                    point_array.end(),
                                    [](const Point &a, const Point &b) { return a.x < b.x; })->x;
      int max_x1 = std::max_element(point_array.begin(),
                                    point_array.end(),
                                    [](const Point &a, const Point &b) { return a.x < b.x; })->x;
      int min_y1 = std::min_element(point_array.begin(),
                                    point_array.end(),
                                    [](const Point &a, const Point &b) { return a.y < b.y; })->y;
      int max_y1 = std::max_element(point_array.begin(),
                                    point_array.end(),
                                    [](const Point &a, const Point &b) { return a.y < b.y; })->y;

      int min_x2 = std::min_element(other.point_array.begin(),
                                    other.point_array.end(),
                                    [](const Point &a, const Point &b) { return a.x < b.x; })->x;
      int max_x2 = std::max_element(other.point_array.begin(),
                                    other.point_array.end(),
                                    [](const Point &a, const Point &b) { return a.x < b.x; })->x;
      int min_y2 = std::min_element(other.point_array.begin(),
                                    other.point_array.end(),
                                    [](const Point &a, const Point &b) { return a.y < b.y; })->y;
      int max_y2 = std::max_element(other.point_array.begin(),
                                    other.point_array.end(),
                                    [](const Point &a, const Point &b) { return a.y < b.y; })->y;
