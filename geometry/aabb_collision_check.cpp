...
class Box {
  public:
    ...
    Box(const pair<double, double> &p1,
        const pair<double, double> &p2,
        const pair<double, double> &p3,
        const pair<double, double> &p4) {
      vertex = {p1, p2, p3, p4};
    }
    ...
    bool collision_check(const Box &other) {
      ...
      double min_x_other, max_x_other, min_y_other, max_y_other;
      min_x = min_element(vertex.begin(),
                          vertex.end(),
                          [](const pair<double, double> &p1, const pair<double, double> &p2) {
                            return p1.first < p2.second;
                          })->first;
      max_x = max_element(vertex.begin(),
                          vertex.end(),
                          [](const pair<double, double> &p1, const pair<double, double> &p2) {
                            return p1.first < p2.second;
                          })->first;
      min_y = min_element(vertex.begin(),
                          vertex.end(),
                          [](const pair<double, double> &p1, const pair<double, double> &p2) {
                            return p1.second < p2.second;
                          })->second;
      max_y = max_element(vertex.begin(),
                          vertex.end(),
                          [](const pair<double, double> &p1, const pair<double, double> &p2) {
                            return p1.second < p2.second;
                          })->second;
      min_x_other = min_element(other.vertex.begin(),
                                other.vertex.end(),
                                [](const pair<double, double> &p1, const pair<double, double> &p2) {
                                  return p1.first < p2.second;
                                })->first;
      max_x_other = max_element(other.vertex.begin(),
                                other.vertex.end(),
                                [](const pair<double, double> &p1, const pair<double, double> &p2) {
                                  return p1.first < p2.second;
                                })->first;
      min_y_other = min_element(other.vertex.begin(),
                                other.vertex.end(),
                                [](const pair<double, double> &p1, const pair<double, double> &p2) {
                                  return p1.second < p2.second;
                                })->second;
      max_y_other = max_element(other.vertex.begin(),
                                other.vertex.end(),
                                [](const pair<double, double> &p1, const pair<double, double> &p2) {
                                  return p1.second < p2.second;
                                })->second;
      ...
      bool x_axel_overlap = max_x > min_x_other && max_x_other > min_x;
      //判断y轴是否发生了重叠，如果自身的最大y值大于另一个包围盒的最小y值，且另一个包围盒的最大y值大于自身的最小y值，说明y轴发生了重叠
      bool y_axel_overlap = max_y > min_y_other && max_y_other > min_y;
